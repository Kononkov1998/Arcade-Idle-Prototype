...
namespace _Project.Scripts.MinedResources
{
    public class ResourceFactory : MonoBehaviour, IInteractive
    {
        ...
        public StackedResources StartNeededResources => _config.NeededResources;
        ...
        public void Interact(IPlayer player)
        {
            ...
            //Resource resource = CreateResource(type, inventory);
            //TransferResource(resource, type);
            player.Inventory.TransferResource(type, _resourceInputPoint.position,
